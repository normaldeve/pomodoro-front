    ...
    >
      <div className="relative z-10 flex w-full max-w-3xl flex-col">
        ...
        <main className="relative flex flex-col gap-4 md:gap-6">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-white/70 via-white/45 to-white/25 backdrop-blur-3xl border border-white/60 shadow-[0_24px_80px_rgba(0,0,0,0.16)] px-6 py-8 md:px-10 md:py-10 flex flex-col items-center justify-center gap-4 overflow-hidden w-full">
